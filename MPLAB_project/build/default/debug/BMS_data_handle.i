...
_Bool can_rx_receive_flag = 0, status1, status2, status3, status4, status5, status6, status7, status8, status9, status10;
 ...
 void DefaultFIFO1NotEmptyHandler(void) {
    ...
    while (1) {
        if (CAN1_ReceivedMessageCountGet() > 0) {
            if (1 == CAN1_ReceiveFrom(FIFO1, &Receive_message))
            {
                break;
            }
        }
